...
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_81__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_keys__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_keys___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_keys__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ct_utility__ = __webpack_require__(81);
...
var isValueBroken = function isValueBroken(value, list) {
    var valueKeysCount = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_keys___default()(value).length;
    var listIsNotEmpty = list.length > 0;

    if (valueKeysCount > 0 && listIsNotEmpty) {
        var simpleKeysCount = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_keys___default()(list[0]).length;
...
var getMatchListByBrokenValue = function getMatchListByBrokenValue(value, list) {
    var matchList = list.filter(function (item) {
        var keysInSelected = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_keys___default()(value);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        matched: function matched() {
            ...
            if (this.input !== '' && !this.focusFlag) {
                var matched = this.list.filter(function (item) {
                    var matchAtLeastOneMatchKey = _this.matchKeys.some(function (key) {
                        if (_this.caseInsensitive) {
                            var itemKeyLowerCased = (item[key] + '').replace(/([a-zA-Z])/g, function ($0, $1) {
                                return $1.toLowerCase();
                            });
                            var inputLowerCased = _this.input.replace(/([a-zA-Z])/g, function ($0, $1) {
                                return $1.toLowerCase();
                            });

                            return itemKeyLowerCased.indexOf(inputLowerCased) > -1;
                        }
                        return (item[key] + '').indexOf(_this.input) > -1;
                    });
                ...
                if (matched.length > 0) {
                    return matched;
                } else if (this.selectedContent.indexOf(this.input) > -1 && !__WEBPACK_IMPORTED_MODULE_3_ct_utility___default.a.base.isEmptyObject(this.selected)) {
        ...
        selectedContent: function selectedContent() {
            ...
            if (!__WEBPACK_IMPORTED_MODULE_3_ct_utility___default.a.base.isEmptyObject(this.selected)) {
    ...
    methods: {
        initSelected: function initSelected() {
            ...
            if (typeof value === 'string') {
                ...
                var valueIsBroken = isValueBroken(value, this.list);
    ...
    watch: {
        ...
        selected: function selected(newVal, oldVal) {
            ...
            if (__WEBPACK_IMPORTED_MODULE_3_ct_utility___default.a.base.isEmptyObject(newVal)) {
                this.$emit('clear');
            }
        }
    }
