...
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_77__) {
...
Component.options.__file = "/Users/rubyisapm/teamshare/adc-packages/auto-complete/src/component/main.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-392b65c8", Component.options)
  } else {
    hotAPI.reload("data-v-392b65c8", Component.options)
  }
})()}
...
var update = __webpack_require__(41)("c7a0251a", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-392b65c8\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./main.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-392b65c8\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./main.vue");
...
// module
exports.push([module.i, "\n.autoComplete .dropdown-menu[data-v-392b65c8] {\n    width: 100%;\n    max-height: 400px;\n    overflow-y: scroll;\n    display: block;\n}\n.autoComplete .dropdown-menu li[data-v-392b65c8] {\n    cursor: pointer;\n}\n.autoComplete .noResult[data-v-392b65c8] {\n    padding: 3px 20px;\n}\n.form-control-feedback[data-v-392b65c8] {\n    cursor: pointer;\n    pointer-events: inherit;\n}\n.has-feedback[data-v-392b65c8] {\n    padding-right: 25px;\n}\n.has-feedback[data-v-392b65c8]::-ms-clear {\n    display: none;\n}\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ct_utility__ = __webpack_require__(77);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__module_util__ = __webpack_require__(78);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        matched: function matched() {
            ...
            var shouldReturnWholeList = this.focusFlag && this.allForEmpty || this.allForEmpty;
            var shouldFilterByInput = this.input !== '' && !this.allForEmpty;

            if (shouldFilterByInput) {
                var matched = this.list.filter(function (item) {
                    return Object(__WEBPACK_IMPORTED_MODULE_3__module_util__["c" /* matchAtLeastOneKey */])(item, _this.input, _this.matchKeys, _this.caseSensitive);
                });
                var shouldReverseSelected = this.selectedContent.indexOf(this.input) > -1 && !__WEBPACK_IMPORTED_MODULE_2_ct_utility___default.a.base.isEmptyObject(this.selected);
        ...
        selectedContent: function selectedContent() {
            ...
            if (!__WEBPACK_IMPORTED_MODULE_2_ct_utility___default.a.base.isEmptyObject(this.selected)) {
    ...
    methods: {
        initSelected: function initSelected() {
            ...
            if (typeof value === 'string') {
                ...
                var valueIsBroken = Object(__WEBPACK_IMPORTED_MODULE_3__module_util__["b" /* isValueBroken */])(value, this.list);

                if (valueIsBroken) {
                    targetItems = Object(__WEBPACK_IMPORTED_MODULE_3__module_util__["a" /* getMatchListByBrokenValue */])(value, this.list);
                ...
                this.$nextTick(function () {
                    if (__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(_this3.selected) === '{}') {
                        _this3.input = '';
                    } else {
                        _this3.input = _this3.selectedContent;
                    }
                });
            }
        },
        clickHandler: function clickHandler(event) {
            ...
            if (this.input !== '') {
                var mayDelSelectedInput = this.selectedContent.indexOf(this.input) > -1 && !__WEBPACK_IMPORTED_MODULE_2_ct_utility___default.a.base.isEmptyObject(this.selected);
        ...
        select: function select(item, event) {
            ...
            this.$nextTick(function () {
                _this5.input = _this5.selectedContent;
            });
            this.listVisible = false;
        },
        getValue: function getValue() {
            if (!this.autoClear && __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(this.selected) === '{}') {
                return this.input;
            }
        ...
        hideList: function hideList() {
            ...
            if (this.autoSelectIfOne && this.matched.length === 1) {
                this.selected = this.matched[0];
                this.$nextTick(function () {
                    _this6.input = _this6.selectedContent;
                });
            }
            if (this.autoClear) {
                this.input = this.selectedContent;
    ...
    watch: {
        ...
        input: function input(newVal, oldVal) {
            ...
            if (__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(newVal) !== __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(oldVal) && !this.autoClear && __WEBPACK_IMPORTED_MODULE_2_ct_utility___default.a.base.isEmptyObject(this.selected)) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-392b65c8", module.exports)
  }
}
