...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        clickHandler: function clickHandler(event) {
            ...
            if (this.input !== '') {
                var isSelectedInput = this.selectedContent === this.input && !__WEBPACK_IMPORTED_MODULE_2_ct_utility___default.a.base.isEmptyObject(this.selected);
                var delSelectedInput = this.selectedContent.indexOf(this.input) > -1 && !__WEBPACK_IMPORTED_MODULE_2_ct_utility___default.a.base.isEmptyObject(this.selected);
    ...
    watch: {
        ...
        input: function input(newVal, oldVal) {
            ...
            if (newVal !== oldVal && !this.autoClear && __WEBPACK_IMPORTED_MODULE_2_ct_utility___default.a.base.isEmptyObject(this.selected)) {
