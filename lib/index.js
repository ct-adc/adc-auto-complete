...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        matched: function matched() {
            ...
            if (shouldFilterByInput) {
                ...
                var shouldReverseSelected = this.selectedContent.indexOf(this.input) > -1 && !__WEBPACK_IMPORTED_MODULE_2_ct_utility___default.a.base.isEmptyObject(this.selected) && this.sticky;
    ...
    methods: {
        ...
        select: function select(item, event) {
            ...
            this.$nextTick(function () {
                _this4.input = _this4.selectedContent;
            });
            this.listVisible = false;
        },
