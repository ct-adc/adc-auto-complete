...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ct_utility__ = __webpack_require__(80);
    ...
    computed: {
        matched: function matched() {
            ...
            if (that.input != '' && !this.focusFlag) {
                var matched = that.list.filter(function (item) {
                    return that.matchKeys.some(function (key) {
                        if (that.caseInsensitive) {
                            ...
                            var inputLowerCased = that.input.replace(/([a-zA-Z])/g, function ($0, $1) {
                                return $1.toLowerCase();
                            });
                ...
                if (matched.length > 0) {
                    return matched;
                } else if (that.selectedContent.indexOf(this.input) > -1 && !__WEBPACK_IMPORTED_MODULE_3_ct_utility___default.a.base.isEmptyObject(that.selected)) {
    ...
    methods: {
        initSelected: function initSelected() {
            ...
            if (typeof value === 'string') {
                this.input = value;
                this.selected = {};
            } else if ((typeof value === 'undefined' ? 'undefined' : __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_typeof___default()(value)) === 'object') {
                ...
                that.$nextTick(function () {
                    if (__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(this.selected) === '{}') {
                        that.input = '';
                    } else {
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
    var base = __webpack_require__(10),
        objTransfer = __webpack_require__(85),
        cookie = __webpack_require__(82),
        localStorage = __webpack_require__(84),
        sessionStorage = __webpack_require__(86),
        URIParser = __webpack_require__(81),
        numberFormat=__webpack_require__(38),
        dateFilter=__webpack_require__(83);
 ...
 */
!(__WEBPACK_AMD_DEFINE_RESULT__ = function() {
	var numberFormat = __webpack_require__(38),
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__auto_complete_vue__ = __webpack_require__(39);
